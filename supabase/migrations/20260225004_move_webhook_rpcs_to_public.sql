-- ============================================================
-- Move webhook-critical RPCs from zapcatalog to public schema
-- Supabase PostgREST only exposes public (and graphql_public).
-- All functions below use SECURITY DEFINER to access zapcatalog.
-- ============================================================

-- zc_get_agent_by_instance_token
